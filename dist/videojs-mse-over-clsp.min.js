...
function () {
  ...
  function Conduit(clientId, _ref2) {
    ...
    this.clientId = clientId;
    this.logger = Object(logger["a" /* default */])().factory("Conduit ".concat(this.clientId));
    this.logger.debug('Constructing...');
...
function () {
  ...
  function IOVPlayer(iov, videoElement, options) {
    ...
    this.logger = Object(logger["a" /* default */])().factory("IOV Player ".concat(iov.id));
...
function (_Component) {
  ...
  _createClass(MqttHandler, [{
    ...
    value: function destroy() {
      ...
      collection["a" /* default */].asSingleton().remove(this.iov.id);
      this.iov = null;
      this.player = null;
    }
  }]);
