...
// EXTERNAL MODULE: ./src/js/utils/logger.js
var utils_logger = __webpack_require__(1);
...
// CONCATENATED MODULE: ./src/js/video-js-plugin/ClspHandler.js
...
var ClspHandler_ClspHandler =
/*#__PURE__*/
function (_Component) {
  _inherits(ClspHandler, _Component);

  function ClspHandler(source, tech, options) {
    var _this;

    _classCallCheck(this, ClspHandler);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ClspHandler).call(this, tech, options.clsp));
    ...
    _this.logger = Object(utils_logger["a" /* default */])().factory('ClspHandler');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                this.updateIov(iov); // @todo - is this functionality needed?  if not, remove this commented
...
// CONCATENATED MODULE: ./src/js/video-js-plugin/ClspSourceHandler.js
 // This is configured as an external library by webpack, so the caller must
// provide videojs on `window`
...
/* harmony default export */ var ClspSourceHandler = (function () {
  var logger = Object(utils_logger["a" /* default */])().factory('ClspSourceHandler');
  return function (mode) {
    var obj = {
      ...
      handleSource: function handleSource(source, tech) {
        ...
        tech.clsp = new ClspHandler_ClspHandler(source, tech, localOptions);
        return tech.clsp;
      },
  ...
  function (_Plugin) {
    ...
    plugin_createClass(ClspPlugin, null, [{
      ...
      value: function register() {
        ...
        var sourceHandler = ClspSourceHandler()('html5');
    ...
    function ClspPlugin(player, options) {
      ...
      plugin_defineProperty(plugin_assertThisInitialized(_this), "onClspHandlerError", function () {
        _this.logger.debug('handling CLSP error...');

        var clspHandler = _this.getClspHandler();
    ...
    plugin_createClass(ClspPlugin, [{
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  clspHandler = this.getClspHandler();
                  ...
                  throw new Error("VideoJS Player ".concat(player.id(), " does not have CLSP tech!"));

                case 4:
                  clspHandler.off('error', this.onClspHandlerError);
                  clspHandler.on('error', this.onClspHandlerError);
                  _context5.next = 8;
                  return clspHandler.createIov(player);
                ...
                case 14:
                  _context5.next = 16;
                  return iov.changeSrc(clspHandler.source_.src).firstFrameReceivedPromise;
      ...
      value: function destroy() {
        ...
        try {
          var clspHandler = this.getClspHandler(player);
          clspHandler.destroy();
          clspHandler.off('error', this.onClspHandlerError);
          var visibilityChangeEventName = utils["a" /* default */].windowStateNames.visibilityChangeEventName;
