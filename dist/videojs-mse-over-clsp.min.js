...
var utils_logger = Object(logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory();
...
function browserIsCompatable() {
  ...
  if (!isFirefox && !isChrome) {
    utils_logger.debug('Unsupported browser');
    return false;
  } // For the MAC
  ...
  if (!window.MediaSource) {
    utils_logger.error('Media Source Extensions not supported in your browser: Claris Live Streaming will not work!');
    return false;
...
function () {
  ...
  function Conduit(clientId, _ref2) {
    ...
    this.iovId = iovId;
    this.logger = Object(logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory("Conduit ".concat(this.iovId));
    this.logger.debug('Constructing...');
    this.clientId = clientId;
...
function () {
  ...
  function IOVPlayer(iov, videoElement, options) {
    ...
    player_defineProperty(this, "onMoov",
    /*#__PURE__*/
    function () {
      var _ref = player_asyncToGenerator(
      /*#__PURE__*/
    ...
    player_defineProperty(this, "onMoof", function (mqttMessage) {
    ...
    this.logger = Object(logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory("IOV Player ".concat(iov.id));
  ...
  player_createClass(IOVPlayer, [{
    ...
    key: "play",
    value: function () {
      var _play = player_asyncToGenerator(
      /*#__PURE__*/
...
function () {
  ...
  function IOV(videoElement, config) {
    ...
    utils["a" /* default */].compatibilityCheck();
    this.id = config.id || v4_default()();
    this.logger = Object(logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory("IOV ".concat(this.id));
    this.logger.debug('Constructing...');
    this.metrics = {}; // @todo - there must be a more proper way to do events than this...
  ...
  IOV_createClass(IOV, [{
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                this.player = player_IOVPlayer.factory(this, this.videoElement, {
                  id: this.id
                ...
                this.conduit = Conduit_Conduit.factory(this.config.clientId, {
                  iovId: this.id,
    ...
    key: "play",
    value: function () {
      var _play2 = IOV_asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
    ...
    key: "stop",
    value: function () {
      var _stop2 = IOV_asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "_play",
    value: function () {
      var _play3 = IOV_asyncToGenerator(
      /*#__PURE__*/
...
// CONCATENATED MODULE: ./src/js/iov/collection.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return collection_IovCollection; });


function collection_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function collection_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { collection_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { collection_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
var collection_IovCollection =
/*#__PURE__*/
function () {
  collection_createClass(IovCollection, null, [{
    key: "asSingleton",
  ...
  function IovCollection() {
    ...
    collection_classCallCheck(this, IovCollection);

    collection_defineProperty(this, "_onWindowMessage", function (event) {
      var clientId = event.data.clientId;
    ...
    this.logger = Object(logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory('IovCollection');
    this.logger.debug('Constructing...');
    this.iovs = {};
  ...
  collection_createClass(IovCollection, [{
    key: "create",
    value: function () {
      var _create = collection_asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(url, videoElement) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                iov = IOV_IOV.fromUrl(url, videoElement, {
                  id: ++totalIovCount
                });
                this.add(iov.id, iov);
                _context.next = 4;
...
// EXTERNAL MODULE: ./src/js/utils/bootstrap.js
...
var external_videojs_ = __webpack_require__(4);
...
// EXTERNAL MODULE: ./src/js/iov/collection.js + 5 modules
...
function (_Component) {
  ...
  function MqttHandler(source, tech, options) {
    ...
    _this.logger = Object(utils_logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory('MqttHandler');
  ...
  _createClass(MqttHandler, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 10;
                return collection["a" /* default */].asSingleton().create(this.source_.src, videoElement);
    ...
    value: function updateIOV(iov) {
      ...
      if (this.iov) {
        ...
        collection["a" /* default */].asSingleton().remove(this.iov.id).add(iov.id, iov);
      }
...
/* harmony default export */ var MqttSourceHandler = (function () {
  var logger = Object(utils_logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory('MqttSourceHandler');
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { plugin_defineProperty(target, key, source[key]); }); } return target; }
...
var plugin_logger = Object(utils_logger["a" /* default */])(window.skyline.clspPlugin.logLevel).factory('clsp-videojs-plugin');
/* harmony default export */ var video_js_plugin_plugin = (function () {
  ...
  function (_Plugin) {
    ...
    function ClspPlugin(player, options) {
      ...
      plugin_logger.debug('creating plugin instance');
      ...
      player.on('ready', function () {
        plugin_logger.debug('the player is ready');
        ...
        regeneratorRuntime.mark(function _callee3(event) {
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  plugin_logger.debug('the player encountered an error');
                    ...
                    regeneratorRuntime.mark(function _callee2() {
                      ...
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              plugin_logger.debug('retrying due to error');
      ...
      regeneratorRuntime.mark(function _callee4() {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                plugin_logger.debug('on player play event'); // @todo - it is probably unnecessary to have to completely tear down the
    ...
    plugin_createClass(ClspPlugin, [{
      ...
      key: "destroy",
      value: function destroy() {
        plugin_logger.debug('destroying...');
