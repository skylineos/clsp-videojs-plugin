...
function () {
  ...
  function IOV(videoElement, config) {
    ...
    this.id = config.id || v4_default()(); // This MUST be globally unique!  The MQTT server will broadcast the stream
    ...
    this.clientId = config.clientId || v4_default()();
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                this.player = player_IOVPlayer.factory(this, this.videoElement); // @todo - this seems to be videojs specific, and should be removed or moved
                // somewhere else
                ...
                this.conduit = Conduit_Conduit.factory(this.clientId, {
                  iovId: this.id,
