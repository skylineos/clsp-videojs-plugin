...
function () {
  ...
  _createClass(Conduit, [{
    ...
    value: function initialize(videoElementParent) {
      ...
      return new Promise(function (resolve, reject) {
        _this._onRouterCreate = function (event) {
          ...
          if (_this.clientId.toString() !== clientId) {
          ...
          _this.logger.debug("Message received for \"".concat(eventType, "\" event"));
    ...
    value: function connect() {
      ...
      return new Promise(function (resolve, reject) {
        _this2._onConnect = function (event) {
          ...
          if (_this2.clientId.toString() !== clientId) {
            // This message was intended for another conduit
            return;
          }
          ...
          _this2.logger.debug("Message received for \"".concat(eventType, "\" event"));
    ...
    value: function _command(message) {
      this.logger.debug('Sending a message to the iframe...'); // @todo - we should not be dispatching to '*' - we should provide the SFS
      // host here instead
...
function (_Component) {
  ...
  function MqttHandler(source, tech, options) {
    ...
    _this.logger = Object(_utils_logger__WEBPACK_IMPORTED_MODULE_3__["default"])(window.skyline.clspPlugin.logLevel).factory('MqttHandler');
...
var SUPPORTED_MIME_TYPE = "video/mp4; codecs='avc1.42E01E'";
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var logger = Object(_utils_logger__WEBPACK_IMPORTED_MODULE_1__["default"])(window.skyline.clspPlugin.logLevel).factory('MqttSourceHandler');
...
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plugin */ "./src/js/video-js-plugin/plugin.js");
...
var clspPlugin = Object(_plugin__WEBPACK_IMPORTED_MODULE_3__["default"])(); // @todo - do not initialize the plugin by default, since that is a side
...
var logger = Object(_utils_logger__WEBPACK_IMPORTED_MODULE_3__["default"])(window.skyline.clspPlugin.logLevel).factory('clsp-videojs-plugin');
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var _class, _temp;
...
module.exports = __webpack_require__(/*! /home/user/vagrant/clsp/clsp-videojs-plugin/src/js/video-js-plugin/index.js */"./src/js/video-js-plugin/index.js");
