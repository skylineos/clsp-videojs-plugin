...
var IOVPlayer = function () {
  ...
  function IOVPlayer(iov, playerInstance) {
    ...
    this.MAX_SEQ_PROC = 2;
    this.BUFFER_LIMIT = 6;
    this.EVENT_NAMES = ['firstChunk', 'videoReceived', 'videoInfoReceived'];
    ...
    this.mediaSourceEventListeners = {
      ...
      sourceended: function sourceended() {
        ...
        _this.stop();
        _this.source_buffer_ready = false;
      },
    ...
    this.sourceBufferEventListeners = {
      updateend: function updateend() {
        return _this.onUpdateEnd.apply(_this, arguments);
      },
      error: function error(e) {
    ...
    this.documentEventListeners = {
      visibilitychange: lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(function () {
        return _this.reinitializeMse();
      }, 2000, {
        leading: true,
        trailing: false
      })
  ...
  _createClass(IOVPlayer, [{
    ...
    value: function play(streamName) {
      ...
      this.iov.conduit.transaction('iov/video/' + window.btoa(this.iov.config.streamName) + '/request', function () {
        return _this2.onIovPlayTransaction.apply(_this2, arguments);
    ...
    value: function flushBuffer() {
      ...
      var start = parseInt(this.sourceBuffer.buffered.start(0));
      var end = parseInt(this.sourceBuffer.buffered.end(0));
      var timeBuffered = end - start;
    ...
    value: function onIovPlayTransaction(_ref) {
      var _this4 = this;
      ...
      this.iov.conduit.subscribe(initSegmentTopic, function (_ref2) {
        ...
        _this4.iov.conduit.subscribe(newTopic, function () {
          return _this4.onMoof.apply(_this4, arguments);
        });
        ...
        document.addEventListener('visibilitychange', _this4.documentEventListeners.visibilitychange);
