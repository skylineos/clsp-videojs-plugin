...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__srcdoc_polyfill__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__MqttSourceHandler__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mseOverMqtt__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__conduit_clspConduit_generated_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__conduit_clspConduit_generated_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__conduit_clspConduit_generated_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styles_videojs_mse_over_clsp_scss__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styles_videojs_mse_over_clsp_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__styles_videojs_mse_over_clsp_scss__);
...
var clspPlugin = Object(__WEBPACK_IMPORTED_MODULE_4__mseOverMqtt__["a" /* default */])(defaults, SrcsLookupTable, onPlayerReady);
var mqttSourceHandler = Object(__WEBPACK_IMPORTED_MODULE_3__MqttSourceHandler__["a" /* default */])(SrcsLookupTable, MqttConduitLookup);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__MqttHandler__ = __webpack_require__(10);





/* harmony default export */ __webpack_exports__["a"] = (function (SrcsLookupTable, MqttConduitLookup) {
    /*
        ...
        var obj = {
            ...
            canHandleSource: function canHandleSource(srcObj) {
                ...
                */
                ...
                // restrict to supported browsers only
                if (__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* default */].supported() === false) {
            ...
            handleSource: function handleSource(srcObj, tech) {
                ...
                tech.mqtt = new __WEBPACK_IMPORTED_MODULE_2__MqttHandler__["a" /* default */](SrcsLookupTable, MqttConduitLookup, srcObj, tech, localOptions);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_video_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_video_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_video_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__iov_IOV__ = __webpack_require__(11);
...
var MqttHandler = function (_Component) {
    ...
    function MqttHandler(SrcsLookupTable, MqttConduitLookup, source, tech, options) {
        ...
        _this.enabled = false;
        _this.playing = false;
        _this.SrcsLookupTable = SrcsLookupTable;
        _this.MqttConduitLookup = MqttConduitLookup;
        return _this;
    }
    ...
    _createClass(MqttHandler, [{
        ...
        value: function src(_src) {
            ...
            this.SrcsLookupTable[_src] = this;
        }
    }, {
        key: 'launchIovPlayer',
        value: function launchIovPlayer(onMqttReady) {
            ...
            var iov = new __WEBPACK_IMPORTED_MODULE_1__iov_IOV__["a" /* default */]({
                port: this.port,
...
/* harmony default export */ __webpack_exports__["a"] = (MqttHandler);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uuid_v4__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__MqttTopicHandlers__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__MqttConduitCollection__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__MqttTransport__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__player__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_paho_mqtt__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_paho_mqtt___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_paho_mqtt__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var IOV = function () {
  ...
  function IOV(config, MqttConduitLookup) {
    ...
    this.mqttConduitCollection = new __WEBPACK_IMPORTED_MODULE_3__MqttConduitCollection__["a" /* default */](this.id, MqttConduitLookup);
...
var MqttConduitCollection = function () {
  function MqttConduitCollection(id, MqttConduitLookup) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_video_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_video_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_video_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__package_json__ = __webpack_require__(24);
...
/* harmony default export */ __webpack_exports__["a"] = (function (defaults, SrcsLookupTable, onPlayerReady) {
    /**
     * A video.js plugin.
     *
    ...
    var mseOverMqtt = function mseOverMqtt(options) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].supported() === false) {
        ...
        this.ready(function () {
            ...
            onPlayerReady(_this, __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.mergeOptions(defaults, options));
        });
    };

    mseOverMqtt.VERSION = __WEBPACK_IMPORTED_MODULE_1__package_json__["version"];
    mseOverMqtt.utils = __WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */];
