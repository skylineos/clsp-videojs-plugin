...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mqttConduit_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mqttConduit_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__mqttConduit_js__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__videojs_mse_over_mqtt_scss__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__videojs_mse_over_mqtt_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__videojs_mse_over_mqtt_scss__);
...
window.mqttConduit = function (config, onReady) {
    ...
    */
    ...
    var markup = '<html><head>' + '<script>\n' + jscode + '</script>' + iframe_code + '</head><body onload="mqttRouter();" onunload="onunload();"><body>' + '<div id="message"></div>' + '</body></html>';
