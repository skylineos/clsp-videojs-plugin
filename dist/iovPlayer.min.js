...
function () {
  Conduit_createClass(Conduit, null, [{
    ...
    // seconds
    // seconds
    value: function factory(iovId, clientId, streamConfiguration, containerElement) {
  ...
  function Conduit(iovId, clientId, streamConfiguration, containerElement) {
  ...
  Conduit_createClass(Conduit, [{
    ...
    value: function stop() {
      ...
      this.clearFirstMoofTimeout(); // Stop listening for the moov
              ...
              case 3:
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  _this6.subscribe(_this6.moovRequestTopic, function (_ref4) {
                    ...
                    if (hasMoovTimedOut) {
                      _this6.logger.info('Recevied moov, but moofTimeout has already occurred...');
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                return _context3.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  var hasReceviedFirstMoof = false;
                  _this7.firstMoofTimeout = setTimeout(function () {
                    hasFirstMoofTimedOut = true; // @todo - we could retry
                  ...
                  _this7.subscribe(moofReceivedTopic, function (mqttMessage) {
                    if (!hasReceviedFirstMoof) {
                      ...
                      if (hasFirstMoofTimedOut) {
                        _this7.logger.info('Recevied first moof, but moofTimeout has already occurred...');
    ...
    value: function destroy() {
      ...
      return stopPromise.then(function () {
        _this8.logger.debug('stopped successfully...');

        _this8._freeAllResources();

        _this8.logger.debug('destroy successfully finished...');
      })["catch"](function (error) {
        _this8.logger.debug('stopped unsuccessfully...');

        _this8.logger.error('Error while destroying the Conduit!');

        _this8.logger.error(error);

        _this8._freeAllResources();

        _this8.logger.debug('destroy unsuccessfully finished...');
      });
    }
    /**
    ...
    value: function transaction(topic) {
      ...
      this.subscribe(messageData.resp_topic, function (response) {
        ...
        _this9.unsubscribe(messageData.resp_topic);
      });
...
Conduit_defineProperty(Conduit_Conduit, "PUBLISH_STATS_INTERVAL", 5);
...
function () {
  ...
  ConduitCollection_createClass(ConduitCollection, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(iovId, clientId, streamConfiguration, containerElement) {
        var conduit;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                conduit = Conduit_Conduit.factory(iovId, clientId, streamConfiguration, containerElement);
                this.add(conduit);
...
function () {
  ...
  function IovPlayer(iovId, videoElement, options) {
    ...
    IovPlayer_defineProperty(this, "onMoof", function (mqttMessage) {
      ...
      _this.getSegmentIntervalMetrics(); // Sometimes, the first moof arrives before the onMoov logic (which includes
  ...
  IovPlayer_createClass(IovPlayer, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 8;
                return ConduitCollection_ConduitCollection.asSingleton().create(this.iovId, this.clientId, this.streamConfiguration, this.videoElement.parentNode);
    ...
    value: function stop() {
      ...
      /*#__PURE__*/
      function () {
        var _ref4 = IovPlayer_asyncToGenerator(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context11.prev = _context11.next) {
                ...
                case 5:
                  ...
                  _this4.logger.error('failed to stop the conduit');

                  _this4.logger.error(_context11.t0);
                ...
                case 12:
                  _context11.prev = 12;
                  _context11.next = 15;
                  return _this4.mseWrapper.destroy();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                iovPlayer = IovPlayer_IovPlayer.factory("".concat(this.id, ".").concat(++this.iovPlayerCount), clspVideoElement);
      ...
      regeneratorRuntime.mark(function _callee3(url) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                onPlayerVisible = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : function () {};
              ...
              case 8:
                iovPlayer.on('firstFrameShown', function () {
                  _this3.logger.debug('Got first frame of new stream...');

                  setTimeout(function () {
                    _this3.logger.debug('Destroying old player...');

                    if (_this3.iovPlayer) {
                      _this3.iovPlayer.destroy();
                    }
...
module.exports = JSON.parse("{\"a\":\"0.16.4+4\"}");
