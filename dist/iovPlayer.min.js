          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                iovPlayer = IovPlayer_IovPlayer.factory(this.generatePlayerLogId(), clspVideoElement, function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 5:
                ...
                streamConfiguration = StreamConfiguration.isStreamConfiguration(url) ? url : StreamConfiguration.fromUrl(url);
                _context3.next = 13;
      ...
      regeneratorRuntime.mark(function _callee(videoElementId, url) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                iov = Iov_Iov.factory(videoElementId, url, {
...
module.exports = JSON.parse("{\"a\":\"0.16.4+6\"}");
