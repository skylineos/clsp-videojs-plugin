...
/* harmony default export */ var Router = (function () {
  ...
  var DEFAULT_CONNECTION_TIMEOUT = 120; // Setting this to half of the default value to help with SFS memory
  // management

  var DEFAULT_KEEP_ALIVE_INTERVAL = 30; // The number of seconds to wait for a "publish" message to be delivered
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                this.clientId = "clsp-plugin-".concat(v4_default()());
...
module.exports = JSON.parse("{\"a\":\"0.16.4+17\"}");
    ...
    value: function _changeSrc(index, streamConfiguration) {
      ...
      function () {
        ...
        regeneratorRuntime.mark(function _callee(resolve, reject) {
          var onSuccess, onError, changeSrcResults;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 4;
                  _context.next = 7;
                  return _this.iov.changeSrc(streamConfiguration, false);

                case 7:
                  changeSrcResults = _context.sent;
                  ...
                  _context.next = 12;
                  return changeSrcResults.firstFrameReceivedPromise;
