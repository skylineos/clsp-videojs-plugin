...
_defineProperty(Conduit_Conduit, "STREAM_DATA_TIMEOUT_DURATION", 30);

_defineProperty(Conduit_Conduit, "MOOV_TIMEOUT_DURATION", 30);

_defineProperty(Conduit_Conduit, "FIRST_MOOF_TIMEOUT_DURATION", 45);

_defineProperty(Conduit_Conduit, "PUBLISH_STATS_INTERVAL", 5);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                streamConfiguration = StreamConfiguration["a" /* default */].isStreamConfiguration(url) ? url : StreamConfiguration["a" /* default */].fromUrl(url);
                _context2.next = 11;
              ...
              case 14:
                return _context2.abrupt("return", firstFramePromise);
...
module.exports = JSON.parse("{\"a\":\"0.16.4+8\"}");
...
function () {
  ...
  function TourController(iovCollection, videoElementId) {
    ...
    this.options = {
      ...
      onChangeError: options.onChangeError || function () {}
    };
  }
      ...
      regeneratorRuntime.mark(function _callee() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                resetTimer = _args.length > 0 && _args[0] !== undefined ? _args[0] : false;
                ...
                _context.prev = 4;
                _context.next = 7;
                return this.iov.changeSrc(streamConfiguration);
              ...
              case 10:
                ...
                this.options.onChangeError(_context.t0, this.currentIndex, streamConfiguration);
