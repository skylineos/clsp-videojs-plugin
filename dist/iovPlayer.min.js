...
/* harmony default export */ var Router = (function () {
  ...
  Router.PUBLISH_TIMEOUT = 10; // All events that are emitted by the Router are prefixed with `clsp_router`
  ...
  Router.prototype._publish = function (publishId, topic, payload) {
    ...
    }, Router.PUBLISH_TIMEOUT * 1000); // custom property
...
var DEFAULT_MAX_RECONNECTION_ATTEMPTS = 200;
...
function () {
  ...
  function Conduit(logId, clientId, streamConfiguration, containerElement) {
    ...
    this.publishHandlers = {}; // These can be configured manually after construction
  ...
  _createClass(Conduit, [{
    ...
    value: function destroy() {
      ...
      this.statsMsg = null;
      this.publishHandlers = null; // @todo - can this be safely dereferenced?
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                conduit = Conduit_Conduit.factory(logId, clientId, streamConfiguration, containerElement, onMessageError);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 10;
                return ConduitCollection_ConduitCollection.asSingleton().create(this.generateConduitLogId(), this.clientId, this.streamConfiguration, this.videoElement.parentNode, this.onConduitMessageError);
...
module.exports = JSON.parse("{\"a\":\"0.16.4+9\"}");
