  ...
  _createClass(StreamConfiguration, null, [{
    ...
    value: function generateConfigFromUrl(url) {
      ...
      if (hashUrl === true) {
        ...
        var protocol = useSSL ? 'clsps-hash' : 'clsp-hash';

        var _hashUrl = "".concat(protocol, "://").concat(host, ":").concat(port, "/").concat(streamName, "?start=").concat(query.start, "&end=").concat(query.end, "&token=").concat(query.token);
...
/* harmony default export */ var Router = (function () {
  ...
  function Router(logId, clientId, host, port, useSSL, options) {
    try {
      ...
      this.Reconnect = null; // @todo - there is a "private" method named "_doConnect" in the paho
      ...
      this.clspClient = new Paho.MQTT.Client(this.host, this.port, '/mqtt', this.clientId);
  ...
  Router.prototype._publish = function (publishId, topic, payload) {
    ...
    clspMessage.destinationName = topic; // I tried setting the quality of service to 2, which has the highest level
...
var DEFAULT_STREAM_DATA_TIMEOUT_DURATION = utils["a" /* default */].DEFAULT_STREAM_TIMEOUT;
var DEFAULT_MOOV_TIMEOUT_DURATION = utils["a" /* default */].DEFAULT_STREAM_TIMEOUT;
var DEFAULT_FIRST_MOOF_TIMEOUT_DURATION = utils["a" /* default */].DEFAULT_STREAM_TIMEOUT;
var DEFAULT_MOOF_TIMEOUT_DURATION = utils["a" /* default */].DEFAULT_STREAM_TIMEOUT;
...
var DEFAULT_ROUTER_PUBLISH_TIMEOUT = utils["a" /* default */].DEFAULT_STREAM_TIMEOUT;
...
function () {
  ...
  _createClass(Conduit, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                videoMetaData = _ref4.payloadString;
              ...
              case 9:
                return _context3.abrupt("return", videoMetaData);
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                onMoof = _args5.length > 0 && _args5[0] !== undefined ? _args5[0] : function () {};
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee6(cb) {
        var _ref6, streamList;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                ...
                streamList = _ref6.payloadString;
                return _context6.abrupt("return", streamList);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee7(reconnectionStartedAt, stopTryingToReconnectAt, onSuccess, onFailure) {
        var _this7 = this;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                return _context7.abrupt("return", onFailure(new Error("Failed to reconnect after ".concat(this.reconnectionAttempts, " attempts."))));
              ...
              case 4:
                ...
                return _context7.abrupt("return", onFailure(new Error("Failed to reconnect after ".concat(this.MAX_RECONNECTION_TIME, " seconds."))));
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 8:
                ...
                this.logger.error(_context8.t0); // if the stats cannot be published, treat that as an unexpected
                // disconnection
...
function () {
  ...
  function IovPlayer(logId, videoElement) {
    ...
    IovPlayer_defineProperty(this, "onPlayerError", function (error) {
    ...
    IovPlayer_defineProperty(this, "onMoof", function (clspMessage) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                this.clientId = "clsp-plugin-".concat(utils["a" /* default */].version.replace('+', '-build-'), "-").concat(v4_default()());
...
IovPlayer_defineProperty(IovPlayer_IovPlayer, "EVENT_NAMES", ['metric', 'unsupportedMimeCodec', 'firstFrameShown', 'videoReceived', 'videoInfoReceived']);
...
function () {
  ...
  function Iov(videoElementId) {
    ...
    Iov_defineProperty(this, "onPlayerError", function (error) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                ...
                // creating a new one?
                this.logger.debug('Restart'); // @todo - do we need to handle firstFrameReceivedPromise rejecting here?

                _context5.next = 6;
                return this.changeSrc(this.streamConfiguration).firstFrameReceivedPromise;
...
Iov_defineProperty(Iov_Iov, "EVENT_NAMES", ['metric', 'firstFrameShown', 'videoReceived', 'videoInfoReceived']);
...
module.exports = JSON.parse("{\"a\":\"0.17.0-1\"}");
...
// CONCATENATED MODULE: ./src/js/iov/TourController.js
...
var DEFAULT_TOUR_INTERVAL_DURATION = 10;
var DEFAULT_TOUR_PRELOAD_DURATION = 9;

var TourController_TourController =
/*#__PURE__*/
function () {
  _createClass(TourController, null, [{
    key: "factory",
    value: function factory(iovCollection, videoElementId, options) {
      return new TourController(iovCollection, videoElementId, options);
    }
  }]);

  function TourController(iovCollection, videoElementId) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    _classCallCheck(this, TourController);

    this.logger = Object(logger["a" /* default */])().factory('Tour Controller');
    ...
    this.options = {
      onLoaded: options.onLoad || function () {},
      onShown: options.onShown || function () {}
  ...
  _createClass(TourController, [{
    ...
    value: function addUrls(urls) {
      ...
      for (var i = 0; i < urls.length; i++) {
        this.streamConfigurations.push(StreamConfiguration["a" /* default */].fromUrl(urls[i]));
      }
    }
  }, {
    key: "_cancelChangeSrc",
    value: function _cancelChangeSrc(changeSrcId) {
    ...
    key: "_cancelAllChangeSrcs",
    value: function _cancelAllChangeSrcs() {
      for (var _i = 0, _Object$entries = Object.entries(this.pendingChangeSrcs); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
            changeSrcId = _Object$entries$_i[0],
            pendingChangeSrc = _Object$entries$_i[1];
    ...
    key: "_changeSrc",
    value: function _changeSrc(index, streamConfiguration) {
      var _this = this;

      var stopTryingToPlayerAfter = this.TOUR_INTERVAL_DURATION + this.TOUR_PRELOAD_DURATION;
      var preloadTimeout = null;
      var changeSrcTimeout = null;
      var changeSrcId = null;
      ...
      function () {
        ...
        regeneratorRuntime.mark(function _callee(resolve, reject) {
          var onSuccess, onError, _this$iov$changeSrc, _changeSrcId, firstFrameReceivedPromise;
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  onSuccess = function onSuccess() {
                    _this.logger.debug("Successfull played ".concat(streamConfiguration.streamName));
                    ...
                    delete _this.pendingChangeSrcs[changeSrcId];

                    _this.options.onLoaded(null, index, streamConfiguration);
                  ...
                  onError = function onError(error) {
                    ...
                    _this._cancelChangeSrc(changeSrcId); // Note that we cancel the preloadTimeout here - an error could occur
                    ...
                    _this.options.onLoaded(error, index, streamConfiguration);
                  ...
                  preloadTimeout = setTimeout(function () {
                    ...
                    _this._showNextStream(0, index, streamConfiguration);
                  }, _this.TOUR_PRELOAD_DURATION * 1000); // There is a network timeout configured for playing the stream, which if
                  ...
                  changeSrcTimeout = setTimeout(function () {
                    onError(new Error("Failed to play ".concat(streamConfiguration.streamName, " after ").concat(stopTryingToPlayerAfter, " seconds")));
                  }, stopTryingToPlayerAfter * 1000);
                  _context.prev = 4;
                  _this$iov$changeSrc = _this.iov.changeSrc(streamConfiguration, false), _changeSrcId = _this$iov$changeSrc.id, firstFrameReceivedPromise = _this$iov$changeSrc.firstFrameReceivedPromise;
                  changeSrcId = _changeSrcId;
                  _this.pendingChangeSrcs[changeSrcId] = {
                    id: changeSrcId,
                    timeout: changeSrcTimeout
                  };
                  _context.next = 10;
                  return firstFrameReceivedPromise;
    ...
    key: "_showNextStream",
    value: function _showNextStream(nextStartTime, index, streamConfiguration) {
      var _this2 = this;

      var show = function show() {
        _this2.iov.showNextStream();

        _this2.options.onShown(null, index, streamConfiguration);
      };
      ...
      var showAfter = this.TOUR_PRELOAD_DURATION * 1000 - (Date.now() - nextStartTime);
      ...
      regeneratorRuntime.mark(function _callee2() {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                playImmediately = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : false;
                resetTimer = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
                nextStartTime = playImmediately ? 0 : Date.now(); // Start the tour list over again once the end of the stream list is reached

                if (this.currentIndex === this.streamConfigurations.length) {
                  this.currentIndex = 0;
                }

                streamConfiguration = this.streamConfigurations[this.currentIndex];
                this.currentIndex++; // Store this locally.  Since this is asynchronous, and since next can be
                ...
                _context2.prev = 8;
                _context2.next = 11;
                return this._changeSrc(index, streamConfiguration);

              case 11:
                playSucceeded = true;

                this._showNextStream(nextStartTime, index, streamConfiguration);
              ...
              case 15:
                ...
                this.logger.error("Failed to play ".concat(streamConfiguration.streamName));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                wait = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : true;
              ...
              case 9:
                ...
                this.nextTimeout = setTimeout(function () {
                  if (_this3.nextTimeout) {
                    clearTimeout(_this3.nextTimeout);
                    _this3.nextTimeout = null;
                  } // When the tour resumes, we want to preload the next video for the
                  // configured number of seconds


                  _this3.next(); // We want all subsequent preloads to start at the configured interval
                  ...
                  _this3.interval = setInterval(function () {
                    _this3.next();
                  }, _this3.TOUR_INTERVAL_DURATION * 1000);
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return this.iovCollection.create(this.videoElementId);

              case 2:
                this.iov = _context5.sent;
                _context5.next = 5;
    ...
    value: function destroy() {
      ...
      for (var i = 0; i < this.streamConfigurations.length; i++) {
...
// CONCATENATED MODULE: ./src/js/iov/index.js





window.IovCollection = IovCollection["a" /* default */];
window.TourController = TourController_TourController;
/* harmony default export */ var iov = __webpack_exports__["default"] = ({
  IovCollection: IovCollection["a" /* default */],
  TourController: TourController_TourController
});
