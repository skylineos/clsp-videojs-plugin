...
var paho_mqtt = __webpack_require__(22);
...
/* harmony default export */ var Router = (function () {
  ...
  Router.factory = function (iovId, clientId, host, port, useSSL) {
    return new Router(iovId, clientId, host, port, useSSL);
  };
  /**
   * @private
   *
  ...
  return {
    onload: function onload() {
      try {
        window.router = Router.factory(window.mqttRouterConfig.iovId, window.mqttRouterConfig.clientId, window.mqttRouterConfig.host, window.mqttRouterConfig.port, window.mqttRouterConfig.useSSL);
...
// CONCATENATED MODULE: ./src/js/iov/StreamConfiguration.js
...
function Conduit_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Conduit_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Conduit_createClass(Constructor, protoProps, staticProps) { if (protoProps) Conduit_defineProperties(Constructor.prototype, protoProps); if (staticProps) Conduit_defineProperties(Constructor, staticProps); return Constructor; }

function Conduit_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/*#__PURE__*/
function () {
  Conduit_createClass(Conduit, null, [{
    key: "factory",
    ...
    value: function factory(iovId, clientId, streamConfiguration) {
  ...
  function Conduit(iovId, clientId, streamConfiguration) {
    Conduit_classCallCheck(this, Conduit);
    ...
    this.logger = Object(logger["a" /* default */])().factory("Conduit ".concat(this.iovId));
    this.logger.debug('Constructing...');
    this.statsMsg = {
      byteCount: 0,
      inkbps: 0,
  ...
  Conduit_createClass(Conduit, [{
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  var hasMoofTimedOut = false;

                  _this3.logger.info('Play is registering the moov timeout...');

                  _this3._moovTimeout = setTimeout(function () {
                    hasMoovTimedOut = true; // @todo - we could retry

                    _this3.stop();

                    if (_this3._moovTimeout) {
                      clearTimeout(_this3._moovTimeout);
                      _this3._moovTimeout = null;
                    }

                    reject(new Error("Stream ".concat(streamName, " timed out (moov) after ").concat(Conduit.MOOV_TIMEOUT_DURATION, " seconds")));
                  }, Conduit.MOOV_TIMEOUT_DURATION * 1000);

                  _this3.logger.info('Play is registering the moof timeout...');

                  _this3._moofTimeout = setTimeout(function () {
                    hasMoofTimedOut = true; // If the moov already timed out, then we already rejected
                    ...
                    if (_this3._moofTimeout) {
                      clearTimeout(_this3._moofTimeout);
                      _this3._moofTimeout = null;
                    }

                    reject(new Error("Stream ".concat(streamName, " timed out (moof) after ").concat(Conduit.MOOV_TIMEOUT_DURATION, " seconds")));
                  }, Conduit.FIRST_MOOF_TIMEOUT_DURATION * 1000);

                  try {
                    _this3.logger.info('Play is requesting stream...');

                    _this3.requestStream(streamName, function (_ref) {
                      ...
                      _this3.logger.info('Play is requesting the moov...');
                          ...
                          return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                              switch (_context.prev = _context.next) {
                                case 0:
                                  payloadBytes = _ref2.payloadBytes;
                                  moov = payloadBytes; // @todo - in our error handling, we do not unsubscribe from this
                                  // topic - does that have a negative effect on the SFS?

                                  _this3.logger.info('Play is unsubscribing from the moov topic...');

                                  _this3.unsubscribe(initSegmentTopic);

                                  newTopic = "iov/video/".concat(guid, "/live"); // Set up the listener for the stream itself

                                  _this3.logger.info('Play is requesting the moofs...');

                                  _this3.subscribe(newTopic, function (mqttMessage) {
                                    if (hasMoofTimedOut) {
                                      _this3.logger.info('Recevied a moof, but moofTimeout has already occurred...');
                                  ...
                                  _this3.logger.info('Recevied a moov, but moovTimeout or moofTimeout has already occurred...');
      ...
      return new Promise(function (resolve, reject) {
        try {
          _this4.transaction('iov/jwtValidate', {
            b64_access_url: _this4.streamConfiguration.b64_jwt_access_url,
            token: _this4.streamConfiguration.jwt
          }, function (response) {
      ...
      return new Promise(function (resolve, reject) {
        try {
          _this5.transaction('iov/hashValidate', {
            b64HashURL: _this5.streamConfiguration.b64_hash_access_url,
            token: _this5.streamConfiguration.hash
          }, function (response) {
            // response ->  {"status": 200, "target_url": "clsp://sfs1/fakestream", "error": null}
            if (response.status !== 200) {
              if (response.status === 403) {
    ...
    value: function destroy() {
      ...
      this.disconnect();
      this.iovId = null;
      this.clientId = null; // The caller must destroy the streamConfiguration

      this.streamConfiguration = null; // Destroy iframe
...
Conduit_defineProperty(Conduit_Conduit, "MOOV_TIMEOUT_DURATION", 30);

Conduit_defineProperty(Conduit_Conduit, "FIRST_MOOF_TIMEOUT_DURATION", 45);

Conduit_defineProperty(Conduit_Conduit, "iframeCommands", {
  SUBSCRIBE: 'subscribe',
...
Conduit_defineProperty(Conduit_Conduit, "routerEvents", Router().Router.events);
...
function () {
  ...
  ConduitCollection_createClass(ConduitCollection, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(iovId, clientId, config) {
        var conduit;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.logger.debug("creating a conduit with iovId ".concat(iovId, " and clientId ").concat(clientId));
                conduit = Conduit_Conduit.factory(iovId, clientId, config);
                this.add(conduit);
...
function () {
  IovPlayer_createClass(IovPlayer, null, [{
    key: "factory",
    value: function factory(iovId, videoElement, options) {
      return new IovPlayer(iovId, videoElement, options);
    }
  }]);

  function IovPlayer(iovId, videoElement, options) {
    var _this = this;

    IovPlayer_classCallCheck(this, IovPlayer);

    IovPlayer_defineProperty(this, "onMoov",
    /*#__PURE__*/
    function () {
      var _ref = IovPlayer_asyncToGenerator(
      /*#__PURE__*/
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                _this.conduit.resyncStream(function () {
    ...
    this.iovId = iovId;
    this.logger = Object(logger["a" /* default */])().factory("Iov Player ".concat(this.iovId));
  ...
  IovPlayer_createClass(IovPlayer, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(streamConfiguration) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return ConduitCollection_ConduitCollection.asSingleton().create(this.iovId, this.clientId, this.streamConfiguration);

              case 5:
                this.conduit = _context2.sent;
    ...
    value: function () {
      ...
      function reinitializeMseWrapper(_x4) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 5:
                _context10.prev = 5;
                _context10.next = 8;
                return this.conduit.play(this.streamConfiguration.streamName, this.onMoof);

              case 8:
                _ref3 = _context10.sent;
                mimeCodec = _ref3.mimeCodec;
                moov = _ref3.moov;
    ...
    value: function _freeAllResources() {
      ...
      this.iovId = null; // The Iov will destroy the conduit
...
IovPlayer_defineProperty(IovPlayer_IovPlayer, "SEGMENT_INTERVAL_SAMPLE_SIZE", 5);

IovPlayer_defineProperty(IovPlayer_IovPlayer, "DRIFT_CORRECTION_CONSTANT", 2);
...
function () {
  ...
  function Iov(videoElementId, streamConfiguration) {
    ...
    Iov_defineProperty(this, "onVisibilityChange", function () {
      var hiddenStateName = utils["a" /* default */].windowStateNames.hiddenStateName;
  ...
  Iov_createClass(Iov, [{
    ...
    key: "initialize",
    value: function () {
      var _initialize = Iov_asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                iovPlayer = IovPlayer_IovPlayer.factory(this.id, clspVideoElement);
    ...
    key: "changeSrc",
    value: function () {
      var _changeSrc = Iov_asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(url) {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                onPlayerVisible = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : function () {};
                this.logger.debug('Changing Stream...');
                clspVideoElement = this._prepareVideoElement();
                iovPlayer = IovPlayer_IovPlayer.factory(this.id, clspVideoElement);
                streamConfiguration = StreamConfiguration.fromUrl(url);
                    ...
                    return regeneratorRuntime.wrap(function _callee3$(_context3) {
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            _context3.next = 2;
                            return _this3.iovPlayer.destroy();

                          case 2:
                            _this3.streamConfiguration.destroy();

                            _this3.streamConfiguration = streamConfiguration;
                            _this3.iovPlayer = iovPlayer;
                            onPlayerVisible();
    ...
    value: function clone(streamConfiguration) {
      ...
      var newStreamConfiguration = streamConfiguration.clone(); // @todo - is it possible to reuse the iov player?
    ...
    value: function cloneFromUrl(url) {
      ...
      var clone = this.clone(StreamConfiguration.generateConfigFromUrl(url));
      return clone;
    }
  }, {
    key: "play",
      ...
      regeneratorRuntime.mark(function _callee7() {
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                iovPlayer = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : this.iovPlayer;
                _context7.next = 3;
    ...
    value: function destroy() {
      ...
      var iovPlayerDestroyPromise = this.iovPlayer.destroy();
      this.iovPlayer = null;
      this.videoElement = null;
      this.videoElementParent = null;
      this.events = null;
...
Iov_defineProperty(Iov_Iov, "CONNECTION_CHANGE_PLAY_DELAY", 2);

Iov_defineProperty(Iov_Iov, "VISIBILITY_CHANGE_STOP_DELAY", 1);

Iov_defineProperty(Iov_Iov, "SHOW_NEXT_VIDEO_DELAY", 0.5);
      ...
      regeneratorRuntime.mark(function _callee(videoElementId, url) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                iov = Iov_Iov.factory(videoElementId, StreamConfiguration.fromUrl(url), {
...
module.exports = __webpack_require__(59)(exports);
...
module.exports = JSON.parse("{\"a\":\"0.16.4+1\"}");
...
var isObject = __webpack_require__(6),
    ...
    nativeKeysIn = __webpack_require__(57);
...
/* harmony import */ var srcdoc_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
...
/* harmony import */ var _IovCollection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);




window.IovCollection = _IovCollection__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"];
/* harmony default export */ __webpack_exports__["default"] = (_IovCollection__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]);

/***/ })
/******/ ]);
//# sourceMappingURL=iovPlayer.min.js.map