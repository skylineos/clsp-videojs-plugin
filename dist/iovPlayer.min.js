...
Conduit_defineProperty(Conduit_Conduit, "STREAM_DATA_TIMEOUT_DURATION", 30);
...
function () {
  ...
  IovPlayer_createClass(IovPlayer, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(streamConfiguration) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
      ...
      regeneratorRuntime.mark(function _callee3(url) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                this.logger.debug('Changing Stream...'); // Handle the case of multiple changeSrc requests.  Only change to the last
              ...
              case 9:
                firstFramePromise = new Promise(function (resolve, reject) {
                  iovPlayer.on('firstFrameShown', function () {
                    _this3.changeSrcTimeout = setTimeout(function () {
                      ...
                      _this3.changeSrcTimeout = null;
                      _this3.pendingChangeSrcIovPlayer = false;
                      resolve();
...
Iov_defineProperty(Iov_Iov, "SHOW_NEXT_VIDEO_DELAY", 0.25);
...
module.exports = JSON.parse("{\"a\":\"0.16.4+5\"}");
