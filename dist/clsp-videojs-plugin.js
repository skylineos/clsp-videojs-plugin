...
var Plugin = video_js__WEBPACK_IMPORTED_MODULE_2___default.a.getPlugin('plugin');
  ...
  return _temp = _class = function (_Plugin) {
    ...
    _createClass(ClspPlugin, null, [{
      ...
      value: function register() {
        if (video_js__WEBPACK_IMPORTED_MODULE_2___default.a.getPlugin(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["default"].name)) {
        ...
        video_js__WEBPACK_IMPORTED_MODULE_2___default.a.getTech('Html5').registerSourceHandler(sourceHandler, 0);
        video_js__WEBPACK_IMPORTED_MODULE_2___default.a.registerPlugin(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["default"].name, ClspPlugin);
    ...
    function ClspPlugin(player, options) {
      ...
      _this.options = video_js__WEBPACK_IMPORTED_MODULE_2___default.a.mergeOptions(_extends({}, _this.constructor.getDefaultOptions(), defaults, playerOptions.clsp || {}), options);
